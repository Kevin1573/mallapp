...
//    private Config payConfig;
    ...
    public OrderGoodsResponse orderGoods(OrderGoodsRequest request) {
        ...
        String tradeNo = "qxl" + System.currentTimeMillis();
        ...
        for (OrderGoodsModelRequest modelRequest : modelRequestList) {
            ...
            GoodsHistoryDO goodsHistoryDO = new GoodsHistoryDO()
                    ...
                    .setIsPaySuccess(CompleteEnum.TRUE.getCode())
            ...
            weight = weight + goodsDO.getWeight() * modelRequest.getNum();
        }

        // 邮寄方式改为邮寄和自提，自提则没有快递费
        Double logisticsPrice = 0.0;
        ...
        realPoint += (long) (logisticsPrice * 10);
