...
//            user = userProfileMapper.selectOne(queryWrapper);
//        }
//
//        // 查询订单历史信息(考虑到购物车组合下单，这里先分页查询出订单号列表，再去查询填充数据)
//        QueryWrapper<GoodsHistoryDO> queryWrapper = new QueryWrapper<GoodsHistoryDO>();
...
//        userProfileQuery.eq(UserProfileDO::getInviteUserId, userProfileDO.getId());
